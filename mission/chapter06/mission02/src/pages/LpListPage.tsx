...
export default function LpListPage() {
  ...
  if (isError) {
    return (
      <div className="flex flex-col items-center justify-center h-full gap-4">
        ...
        <button onClick={() => window.location.reload()} className="px-4 py-2 bg-fuchsia-600 rounded">
          다시 시도
        </button>
      </div>
    );
  ...
  const allLps = data?.pages.flatMap(page => page.lps) ?? [];
    ...
    <div className="max-w-7xl mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="px-4 py-2 bg-fuchsia-600 hover:bg-fuchsia-500 rounded transition"
        >
